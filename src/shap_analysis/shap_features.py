...
model_uri = "runs:/a2e830264ac3445bb87dc65327d50967/random_forest_model"
...
# Save the plot in the src/shap_analysis directory
plt.savefig('src/shap_analysis/shap_summary_plot.png', bbox_inches='tight', dpi=300)
print("SHAP summary plot saved to 'src/shap_analysis/shap_summary_plot.png'.")
...
plt.savefig(f'src/shap_analysis/shap_plot_sample_{sample_index}.png', bbox_inches='tight', dpi=300)
print(f"SHAP force plot saved to 'src/shap_analysis/shap_plot_sample_{sample_index}.png'.")
